...
by Bednorz and Lata\l a~\cite{BednorzLatala}. Our proof does not invoke
their theorem. Its main input is the subgaussian convex-comparison theorem
of van Handel~\cite{vanHandel}. The key input for
\cref{thm:bernoulli} is the following convex domination result.
...
We use van Handel's Gaussian comparison in the following form: for a
